...
import product from '../../resourses/img/product.png';
            ...
            <div className="items__slider-item">
                <div className="items__slider-inner">
                    <div className="items__slider-group">
                        <div>
                            <div className="items__slider-title">Abstract 3D work</div>
                            <div className="items__slider-text">Owner: artstudio</div>
                        </div>
                    ...
                    <div className="items__slider-group">
                        <div>
                            ...
                            <div className="items__slider-purple">0.034 ICP</div>
                        </div>
                        <div className="items__slider-user">
                            <img src={user} alt=""/>
                            <Link to="/artstudio" className="items__slider-name">@artstudio</Link>
                        </div>
                    </div>
                </div>
            </div>
